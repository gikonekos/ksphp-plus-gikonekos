...
// secret code (cloudflare-turnstile)
  ...
  //   sub/ 直下に一本化しました。以前ここにあった'TEMPLATE_LANGUAGE'
  //   キーは廃止しています。UI文言の言語切り替えは、下の
  //   'LANGUAGE_FILE'キーのみで行います。
  // NOTE (2026-07-16): The old sub/ja vs sub/en split has been removed;
  //   logic and templates now live directly under sub/. The
  //   'TEMPLATE_LANGUAGE' key that used to be here has been retired.
  //   UI language switching is now handled solely via 'LANGUAGE_FILE'
  //   below.
...
| <a href="https://qptns.com/z/zanteilog/">zanteilog</a>
| <a href="https://qptns.com/cgi-bin/index.cgi" target="_blank">能登川</a> 
| <a href="https://dis.heyuri.net/sw/" target="_blank">heyuri</a>
| <a href="https://qptns.com/test/bbs.php">テス㌧</a>
| <a href="https://github.com/Heyuri/ksphp-plus/archive/refs/heads/main.zip" target="_blank">特設：ksphp+最新版</a>
',
...
#  'TMPL_ENVLIST' => "<div class=\"env\">{val envaddr}{val envbr}{val envua}</div>\n",
  ...
  // If zlib (gzfile) is unavailable, falls back to filter/hashes.txt (plain).
  // Both files are bundled; delete hashes.txt if zlib is confirmed available.
