...
class Bbsadmin extends Webapp {
    ...
    function prtadminmenu() {
        ...
        $this->sethttpheader();
        print $this->prthtmlhead ($this->c['BBSTITLE'] . ' ' . T('TITLE_ADMIN_MENU'));
    ...
    function prtkilllist() {
        ...
        $this->sethttpheader();
        print $this->prthtmlhead ($this->c['BBSTITLE'] . ' ' . T('TITLE_MESSAGE_DELETE_MODE'), '<script type="text/javascript" src="js/admin.js" defer></script>');
    ...
    function prtsetpass() {
        ...
        $this->sethttpheader();
        print $this->prthtmlhead ($this->c['BBSTITLE'] . ' ' . T('TITLE_PASSWORD_SETTINGS'));
    ...
    function prtpass($inputpass) {
        ...
        if (!@$inputpass) {
            $this->prterror (T('NO_PASSWORD_SET'));
        }
