...
* **Auto-renomeação do install.php** — o `_setup.php` muda o próprio nome após a primeira utilização, o `install.php` não. De momento existe apenas a documentação do passo de eliminação.
